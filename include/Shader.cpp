...
Shader::Shader()
{
    ...
    m_shader_program = create_shader_program(m_vertex_shader_source, m_fragment_shader_source);
}
...
unsigned int Shader::create_shader_program(const std::string& vertex_source, const std::string& fragment_source)
{
    // vertex shader
